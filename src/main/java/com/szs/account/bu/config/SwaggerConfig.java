package com.szs.account.bu.config;
...
//                .apiInfo(apiInfo)                             // 문서에 대한 정보를 설정한다.
                ...
                .apis(RequestHandlerSelectors.basePackage("com.ssafy.myapp.controller"))// 대상으로하는 api 설정
//                .paths(PathSelectors.ant("/**/depts/**"))    // controller에서 swagger를 지정할 대상 path 설정
                .build();                                    // Docket 객체 생성            
    }
